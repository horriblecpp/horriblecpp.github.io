...
function updateGameWorld(deltaTime) {
	...
	drawString(800, -200, 0, 10, gameWorldEducationAlpha / 30, this.window.resume[1]);
	drawString(1200, -200, 0, 10, gameWorldEducationGoalAlpha / 30, this.window.resume[2]);
	drawString(1600, -200, 0, 10, gameWorldCourseWorkAlpha / 30, this.window.resume[3]);

	drawString(2000, -200, 0, 10, gameWorldExperienceAlpha / 30, this.window.resume[4]);
	drawString(2100, -550, 0, 10, gameWorldExperienceAlpha / 30, this.window.resume[4]);	
